...
export default class Error {
    ...
    static locked(){
        return new Error(ErrorTypes.LOCKED, "The user's Gold is locked. They have been notified and should unlock before continuing.")
    }
    ...
    static usedKeyProvider(){
        return new Error(
            ...
            "Do not use a `keyProvider` with a Gold. Use a `signProvider` and return only signatures to this object. A malicious person could retrieve your keys otherwise.",
